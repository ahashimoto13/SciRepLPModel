function [closestpts,endpts,time_closest] = run_replicate(initial_point, find_point, map_data, T, p_behavior, alpha, LL)
...
ind_end = find(~isnan(x),1,'last');
endpts = [x(ind_end), y(ind_end)];
